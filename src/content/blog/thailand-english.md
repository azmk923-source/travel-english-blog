...
ただしGrabはネット接続が前提のアプリなので、現地のネット回線の準備もセットで考えてください。詳しくは[タイ旅行のWiFi・eSIMはどれがいい？](/blog/thailand-wifi-esim/)にまとめました。
...
### 話す練習にはNativeCamp（オンライン英会話）

旅行英語で一番大事なのは「話す練習」です。

**NativeCamp**はレッスン回数無制限のオンライン英会話で、「タクシーで行き先を伝える」「ホテルでリクエストする」などのシーン練習を講師相手に何度でもできます。
